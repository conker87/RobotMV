...
public class ThePlayer : MonoBehaviour
{
	...
	void Update ()
	{
		...
		// Jumping
		if (Input.GetButtonDown("Jump") && canTripleJump && (PlayerAbilities.Current.TripleJump && !hasTripleJumped) &&
		...
		else if (Input.GetButtonDown("Jump") && canDoubleJump && (PlayerAbilities.Current.DoubleJump && !hasDoubleJumped) &&
		           									hasJumped )
		{
			velocity.y = jumpVelocity;
		...
		else if (Input.GetButton("Jump") && PlayerAbilities.Current.Jump && controller.collisions.below)
		{
			velocity.y = jumpVelocity;
